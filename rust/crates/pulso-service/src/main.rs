//! Pulso RF Engine — gRPC server entry point.
//!
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tracing::info!("Pulso RF Engine v{}", env!("CARGO_PKG_VERSION"));
    tracing::info!("SRTM tile directory: {}", config.srtm_tile_dir);
    tracing::info!("DSM tile directory: {}", config.dsm_tile_dir);
