//! # pulso-propagation
//!
//! RF propagation modeling for the Pulso telecom intelligence platform.
//!
...
//! | [`models::tr38901`] | 500-100000 MHz | 5G NR coverage: RMa, UMa, UMi, InF + beamforming |
...
//! use pulso_propagation::models::{PropagationModel, PathLossParams, Environment};
//!
...
pub use antenna::{AntennaDatabase, AntennaPatternData, link_budget_with_antenna};
pub use common::{
