...
class Settings(BaseSettings):
    ...
    # CORS
    cors_origins: List[str] = ["http://localhost:3000", "http://localhost:4100", "https://app.pulso.network", "http://144.76.2.72:4100", "https://pulso.network", "https://www.pulso.network"]
