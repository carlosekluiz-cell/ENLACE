...
// ---------------------------------------------------------------------------
// TAB 6 : Due Diligence — Gated CTA (separate product)
// ---------------------------------------------------------------------------

function DossierTab() {
  return (
    <div className="space-y-6">
      <div className="pulso-card text-center" style={{ border: '1px solid color-mix(in srgb, var(--accent) 30%, transparent)' }}>
        <div className="mx-auto max-w-lg py-8">
          <ShieldAlert size={48} className="mx-auto mb-4" style={{ color: 'var(--accent)' }} />
          <h2 className="mb-3 text-xl font-bold" style={{ color: 'var(--text-primary)' }}>
            Pulso Due Diligence
          </h2>
          <p className="mb-2 text-sm" style={{ color: 'var(--text-secondary)' }}>
            Produto separado com análise fiscal, societária e regulatória de provedores-alvo.
          </p>
          <p className="mb-6 text-sm" style={{ color: 'var(--text-muted)' }}>
            Relatório confidencial sob NDA com audit trail completo. Inclui dívidas PGFN, grafo societário, sanções e reclamações.
          </p>
          <div className="mb-6 rounded-lg p-4" style={{ backgroundColor: 'var(--bg-subtle)' }}>
            <div className="grid grid-cols-1 gap-3 text-left sm:grid-cols-3">
              <div>
                <p className="text-[10px] font-medium uppercase" style={{ color: 'var(--text-muted)' }}>Acesso</p>
                <p className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>Sob contrato</p>
              </div>
              <div>
                <p className="text-[10px] font-medium uppercase" style={{ color: 'var(--text-muted)' }}>NDA</p>
                <p className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>Obrigatório</p>
              </div>
              <div>
                <p className="text-[10px] font-medium uppercase" style={{ color: 'var(--text-muted)' }}>Audit trail</p>
                <p className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>Completo</p>
              </div>
            </div>
          </div>
          <a
            href="mailto:contato@pulso.network?subject=Pulso Due Diligence"
            className="pulso-btn-primary inline-flex items-center gap-2"
          >
            <ShieldAlert size={16} />
            Entre em contato
          </a>
...
export default function MnaPage() {
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <DisclaimerBanner
        level="red"
        message="Valuations sao estimativas indicativas baseadas em dados publicos. Nao constituem laudo de avaliacao formal, recomendacao de investimento ou parecer juridico. Acesso completo aos modulos de M&A, Due Diligence e Seller Intelligence requer contratacao especifica com termo assinado."
        ctaHref="/contato"
